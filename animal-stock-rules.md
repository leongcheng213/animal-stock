...
You all work at the same animal sanctuary. Every day, animals arrive in crates and the
staff take in requests for them — but nobody bothers to check what actually arrived.

Each of you can see what everyone else received. You cannot see your own.

So when someone accepts another request, you have to ask yourself: do we actually have
the animals to cover that, or is this person bluffing and hoping the crate in front of me
saves them?

If you think too much has been promised, ring the bell and call the manager. But be sure
— the manager gets angrier every time she's called, and someone is always blamed.
...
animal. The other half shows **two or three** of a different animal.
...
The same cards do two different jobs:

| Where it is | What counts |
|---|---|
| **In front of a player** — this is **stock**, what you have | **Both halves** |
| **On the request board** — this is a **promise** you've made | **One half only**, chosen by the player |

**The manager.** A hippo. She has three siblings who wander in and cause problems (more
on them below).
...
Draw the top card. Pick one of its two halves and put that half on the request board.
The other half is ignored.

You're now promising the sanctuary can cover everything on that board — including all the
promises made before yours.

### Ring the bell

If you think the board has gone too far, don't add to it. Ring the bell instead.

Everything stops, every stock card is revealed, and the totals get checked.

You can only ring on your own turn, and only if there's at least one request on the board.
This is the tense part: you might see the mistake on someone else's turn and have to sit
there hoping nobody covers it before your turn comes around.
...
Three cards in the deck are the manager's siblings. What they do depends on where they
turn up.
...
This is where the game gets funny. You might be sitting there confidently counting animals
that don't exist, while everyone watches you do it — or you might be quietly holding the
one card that makes everyone else's careful maths wrong.

---

## Getting blamed

The blamed player takes an anger token. The first one is worth **1**. The next round it's
worth **2**, then **3**, and so on up to **7**.

So early mistakes are cheap and late ones are ruinous. By round five, calling the bell
...
The moment someone's anger tokens add up to **7 or more**, the game stops.

**The player with the fewest points wins.** Everyone else just wasn't the worst.
